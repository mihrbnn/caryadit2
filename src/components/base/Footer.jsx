...
function Footer(props) {
  return (
    <>
      <div>
        <footer id="footer" className="mt-5 bg-dark text-light p-3">
              ...
              <tr>
                ...
                <td>
                  ...
                  <div>
                    ...
                    >
                      <span className="text-light">
                        Mihriban Kılıçkan <AiFillGithub />
                      </span>
                    </a>
                  </div>
                </td>
